Shader "MyCustom_URP_Shader/URP_WaterFade"
{
    Properties
    {
        ...
        _TransparenciaMultiply("Transparencia mult",float) = 1
        _TransparenciaAdd("Transparencia add",float) = 0
        _Bias("Bias",float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Water_FowardLit_passFade.hlsl"
